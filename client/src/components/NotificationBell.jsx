...
const BellIcon = () => (
  <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    <path d="M18 10.7V9a6 6 0 0 0-12 0v1.7c0 2.2-.7 3.5-1.4 4.5-.4.6 0 1.4.8 1.4h13.2c.8 0 1.2-.8.8-1.4-.7-1-1.4-2.3-1.4-4.5Z" />
    <path d="M9.7 18.7a2.4 2.4 0 0 0 4.6 0" />
  </svg>
);
